...
new_proper_sentence = "i really like programming.".upcase

puts proper_sentence
puts new_proper_sentence
...
puts sentence.gsub(/[a A]/, 'a' => 'o', 'A' => 'O')